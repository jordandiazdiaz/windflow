...
exports.WindFlowClassDatabase = void 0;
const fuse_js_1 = __importDefault(require("fuse.js"));
class WindFlowClassDatabase {
    constructor() {
        this.classes = [];
        this.initializeClasses();
        this.fuse = new fuse_js_1.default(this.classes, {
...
exports.WindFlowClassDatabase = WindFlowClassDatabase;
